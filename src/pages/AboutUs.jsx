  ...
  return (
    <>
      ...
      <main className="bg-white text-duke-dark py-16 px-6 max-w-7xl mx-auto space-y-20">
        ...
        {/* Our Mission / Values */}
        <section className="grid md:grid-cols-3 gap-10 bg-[#f7f8f6] py-12 px-6">
          {[
            {
              icon: historyIcon,
            ...
            <div
              key={i}
              className="flex flex-col items-center text-center px-4 py-8 bg-white shadow-md rounded-xl transition-transform hover:scale-[1.02]"
            >
