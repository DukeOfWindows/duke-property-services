      ...
      >
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 flex flex-col h-full">
          <div className="flex-1 flex items-center sm:items-center sm:text-center">
            ...
            >
              <p className="text-duke-dark font-cursive text-2xl mb-1 relative inline-block after:content-[''] after:absolute after:top-1/2 after:left-full after:ml-2 after:w-10 after:h-[2px] after:bg-duke-brown after:transform after:-translate-y-1/2">
                {eyebrow}
              </p>
